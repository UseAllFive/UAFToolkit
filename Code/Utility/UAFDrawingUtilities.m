...
CGFloat UAFFLimit(CGFloat f, CGFloat min, CGFloat max) {
...
void UAFDrawRoundedRect(CGContextRef context, CGRect rect, CGFloat cornerRadius) {
...
CGGradientRef UAFCreateGradientWithColors(NSArray *colors) {
	return UAFCreateGradientWithColorsAndLocations(colors, nil);
}


CGGradientRef UAFCreateGradientWithColorsAndLocations(NSArray *colors, NSArray *locations) {
...
void UAFDrawGradientInRect(CGContextRef context, CGGradientRef gradient, CGRect rect) {
